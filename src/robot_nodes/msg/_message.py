...
"""autogenerated by genpy from robot_nodes/message.msg. Do not edit."""
import sys
...
import std_msgs.msg
import robot_nodes.msg
import sensor_msgs.msg

class message(genpy.Message):
  _md5sum = "7a6338a097fce8b915d51a0f77222c36"
  _type = "robot_nodes/message"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """#Globall messages structure used by all ROS nodes in our network

#FRAME data structure; defined in FRAME.msg
...
#Custom data - add your custom message on CUSTOM.msg file
CUSTOM custom
...
================================================================================
MSG: robot_nodes/CUSTOM
#Adding custom data here
...
MSG: std_msgs/Bool
bool data"""
  __slots__ = ['image','imu','rois','custom']
  _slot_types = ['sensor_msgs/Image','robot_nodes/IMU','robot_nodes/ROIS','robot_nodes/CUSTOM']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.imu is None:
        self.imu = robot_nodes.msg.IMU()
      if self.rois is None:
        self.rois = robot_nodes.msg.ROIS()
      if self.custom is None:
        self.custom = robot_nodes.msg.CUSTOM()
    else:
      self.image = sensor_msgs.msg.Image()
      self.imu = robot_nodes.msg.IMU()
      self.rois = robot_nodes.msg.ROIS()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_iB.pack(_x.custom.int_var1.data, _x.custom.bool_var1.data))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.custom.str_var1.data = str[start:end].decode('utf-8')
      else:
        self.custom.str_var1.data = str[start:end]
      _x = self
      start = end
      end += 5
      (_x.custom.int_var1.data, _x.custom.bool_var1.data,) = _struct_iB.unpack(str[start:end])
      self.custom.bool_var1.data = bool(self.custom.bool_var1.data)
      return self
