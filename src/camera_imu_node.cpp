...
robot_nodes::message initMSG()
{
    robot_nodes::message msg;
...
int main(int argc, char** argv)
{
    ...
    ros::Publisher publisher = n.advertise<robot_nodes::message>("camera_imu_topic", 1);
    ...
    robot_nodes::message msg = initMSG(); //fill all fields with 0 values
