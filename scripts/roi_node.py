...
from robot_nodes.msg import message
...
if __name__ == '__main__':
	...
	hSubscriber = rospy.Subscriber("camera_imu_topic", message, callback)			    #Subscriber handler
	hPublisher  = rospy.Publisher("roi_topic", message, queue_size=1)	#Publisher handler
